    ...
    return (
      <div>
        ...
        <div className='wrapper'>
          <div className='wrapper1'><Link to='/travel/blog/1'><img src={latest1} alt='latest'></img>
            ...
            <div className='date'>Travel <span>/ November 17 2021</span></div></Link>

          </div>
          <div className='wrapper2'><Link to='/travel/blog/2'><img src={latest2} alt='latest'></img>
          ...
          <div className='wrapper3'><Link to='/travel/blog'><img src={latest3} alt='latest'></img>
            <h2>The Stone Chariot</h2>

      ...
      <div className='container3'>
        <div className='box31'>
            <div className='one3'>
               ...
               <div>
               <Link to='/travel/blog'><h2>Bollywood Hungama</h2></Link> 
        ...
        <div className='box32'>
            <div className='one3'>
                   ...
                   <div>
                   <Link to='/travel/blog'><h2>Health & Fitness Guide</h2></Link>  
        ...
        <div className='box33'>
             <div className='one3'>
                ...
                <div>
                <Link to='/travel/blog'><h2>Largest superconducting quantum computer</h2></Link> 
        ...
        <div className='box34'>
             <div className='one3'>
                ...
                <div>
                <Link to='/travel/blog'><h2>Behind Hollywood’s Alternate History</h2></Link>
        ...
        <div className='box36'>
           <div className='box361'>
             <h2>Top Posts <hr/></h2>
             <img src={latest4} alt='topost'></img>
             <h4>Catch waves with an adventure guide</h4>
             <div className='date3'>Travel <span>/ November 17 2021</span></div>
           </div> 
        </div>
      </div>
    </div>

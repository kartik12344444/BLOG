    ...
    return (
      <div>
        <div className='container4'>
          <div className='box41'>
               <img src={box4} alt='type1'></img>
          </div>
          <div className='box42'>
               <div className='one4'>
               <img src={box42} alt='type1'></img>
               <div className='host'>Fly to the Village You Love the most
          ...
          <div className='box43'>
               ...
               <div className='host'>The most peacefull city in the UK
               <div className='date4'>Travel <span>/ November 17 2021</span></div>
               </div>
          ...
          <div className='box44'>
               ...
               <div className='host'>Enjoy your vacation to the most 
               <div className='date4'>Travel <span>/ November 17 2021</span></div>
               </div>
